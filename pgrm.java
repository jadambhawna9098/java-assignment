...
4. WAP to exchange value to two variable with third variable and 
...
28. Write a C program to input electricity unit charges and calculate total electricity bill
    ...
    Rs. 0.75/unit For next 100 units Rs. 1.20/unit For unit above 250 Rs. 1.50/unit An 
...
29. Write a program to input choice from user. If user enter ‘+’ as choice then calculate 
    addition of 2 number. If Choice ‘>’ then check which number is greaterst. 
